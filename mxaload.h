...
#ifdef __3DS__
/* Must be == MAXMODELHEADERS — model indices are shared between MX and MXA
 * headers, so the smaller of the two limits the system. See models.h for
 * the sizing rationale. */
#define	MAXMXAMODELHEADERS		608
#else
