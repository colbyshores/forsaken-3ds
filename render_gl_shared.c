...
/* Stub: only the citro3d render path uses per-group scissor mode
 * (visi.c forces it on for level-mesh draws to fix PICA200-specific
 * portal-edge flicker; see render_c3d.c::FSSetViewPort). picaGL /
 * PC GL1 stick with the engine-standard sub-rect viewport. */
